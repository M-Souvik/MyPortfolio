    ...
    <div className='grid grid-cols-3 mt-16 gap-6'>
      <div className="col-span-2 flex flex-row justify-center">
        <div className=''>
          ...
          <Link href="https://promptomania-2-g9t96k35i-souvik-mondals-projects.vercel.app" className='bg-transparent border-2 border-gray-500 rounded-full h-fit w-fit'><span className='flex flex-row gap-2 p-1'>View Project <IoOpenOutline size={20} color='grey'/></span></Link>
          <Link href="https://github.com/Zstar246/Promptomania" className='bg-transparent border-2 border-gray-500 rounded-full h-fit w-fit'><span className='flex flex-row gap-2 p-1'>Github Repository<IoOpenOutline size={20} color='grey'/></span></Link>
          </div>
        </div>
        </div>
        <div>
