        ...
        <div className="col-span-2 flex flex-row justify-center">
          <div>
            ...
            <p className="text-xl font-thin mt-6">
              Promptomania is a Mern-based Project through which users can know what type of prompts they can give to the AI like ChatGPT, Blackbox AI, etc.
            </p>
            <div className="flex flex-row gap-6 mt-9">
              <Link href="https://promptomania-2-g9t96k35i-souvik-mondals-projects.vercel.app">
                <a className="bg-transparent border-2 border-gray-500 rounded-full h-fit w-fit flex flex-row gap-2 p-1">
                  View Project <IoOpenOutline size={20} color="grey" />
                </a>
              </Link>
              <Link href="https://github.com/Zstar246/Promptomania">
                <a className="bg-transparent border-2 border-gray-500 rounded-full h-fit w-fit flex flex-row gap-2 p-1">
                  Github Repository <IoOpenOutline size={20} color="grey" />
                </a>
              </Link>
            </div>
          </div>
